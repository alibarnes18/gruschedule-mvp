...
// Adapted from React Bits (reactbits.dev) — behavior kept as-is, converted
// to TypeScript for this project.
...
export default function LineSidebar({
  ...
  // all move together without staggering CSS transitions. Recurses through
  // runFrameRef (rather than calling itself by name) so the callback stays
  // referentially stable for the linter/compiler while still ticking itself.
